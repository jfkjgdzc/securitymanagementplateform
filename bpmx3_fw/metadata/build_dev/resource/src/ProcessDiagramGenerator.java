...
public class ProcessDiagramGenerator {
	...
	public static ProcessDiagramCanvas generateDiagram(String bpmnXml, List<String> highLightedActivities) {
		...
		drawWaterMark(processDiagramCanvas);
	 ...
	 */
	public static void drawWaterMark(ProcessDiagramCanvas processDiagramCanvas) {
		processDiagramCanvas.drawWaterMark();
	}
...
//			}
	...
	public static Point2D.Double[] caculateCanvasSize(List<BPMNShap> shaps, List<BPMNEdge> edges) {
		...
		maxX=maxX>ProcessDiagramCanvas.getCopyRightWidth()?maxX:ProcessDiagramCanvas.getCopyRightWidth();
		maxY+=ProcessDiagramCanvas.getCopyRightHeight((int)maxX);
