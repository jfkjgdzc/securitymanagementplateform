	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link run"  href="javaScript:void(0)"><span></span>提交</a></div>
				<div class="l-bar-separator"></div>
				</c:if>
				<c:if test="<#noparse>${</#noparse>runId!=0}">
				<div class="group"><a class="link detail" onclick="FlowDetailWindow({runId:<#noparse>${</#noparse>runId}})"" href="javaScript:void(0)"><span></span>流程明细</a></div>
				<div class="l-bar-separator"></div>
				</c:if>
				</#if>
