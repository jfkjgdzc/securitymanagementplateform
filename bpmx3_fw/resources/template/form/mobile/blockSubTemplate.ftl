        ...
        <table class="am-table am-table-bordered am-table-striped">
			<thead>
                  <tr class="ub ub-f1 am-primary">
                      <th colspan="2" style="text-align: center;"> ${subTable.tableDesc}
                      <div style="float: right;"> <a class="am-btn am-btn-danger am-btn-xs" ng-click="removeRow(&#39;${subTable.tableName?lower_case}&#39;,$index)" ng-if="permission.table.${subTable.tableName?lower_case}.del"><em class="am-icon-remove"></em>删除</a></div>
                       </th>
                  </tr>
              </thead>
			 <#if teamFields??>
