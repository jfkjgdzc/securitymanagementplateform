...
//						+ table.getTableName() + ":" + field.getFieldName());
				String input=(table.getIsMain() == 1)? "<@input field=field type=1 />" :"<@input field=field type=2 />";
	...
	public ModelAndView preview(HttpServletRequest request, HttpServletResponse response,BpmMobileFormDef formDef) throws Exception
	{
		...
		return new ModelAndView("/platform/form/bpmMobileformPreview.jsp").addObject("formDef", formDef);
	}
