...
public class ExecutionStackDao extends BaseDao<ExecutionStack>
{
	...
	public List<ExecutionStack> getByActInstIdNodeIdLikeToken(String actInstId,String nodeId, String token){
		if(StringUtil.isEmpty(token)) return getByActInstIdNodeId(actInstId, nodeId);
		Map<String,Object> params=new HashMap<String, Object>();
		params.put("actInstId", actInstId);
		params.put("nodeId", nodeId);
		params.put("token", token + "%");
		return getBySqlKey("getByActInstIdNodeIdLikeToken", params);
	}
	...
	public List<ExecutionStack> getByActInstIdNodeIdToken(String actInstId,String nodeId,String taskToken){
		if(StringUtil.isEmpty(taskToken)){
			return getByActInstIdNodeId(actInstId, nodeId);
		}
		Map<String,Object> params=new HashMap<String, Object>();
		params.put("actInstId", actInstId);
		params.put("nodeId", nodeId);
