...
public class MailReceiver {  
    ...
    private boolean connectToServer() {  
        ...
        if (this.receiverInfo.isValidate()) {  
        	final String user=this.receiverInfo.getUserName();
        	final String pwd=this.receiverInfo.getPassword();
            // 如果需要身份认证，则创建一个密码验证器  
...
//            System.out.println("Other: " + disposition);  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        receiverInfo.setUserName("yg_zhangyg");  
        receiverInfo.setPassword("zhangyg0906");  
        receiverInfo.setAttachmentDir("e:/temp/mail/attach/");  
        receiverInfo.setEmailDir("e:/temp/mail/");  
  
        MailReceiver receiver = new MailReceiver(receiverInfo);  
        receiver.receiveAllMail();  
//    	String str=Base64.getFromBase64("PGRpdiBzdHlsZT0ibGluZS1oZWlnaHQ6MS43O2NvbG9yOiMwMDAwMDA7Zm9udC1zaXplOjE0cHg7Zm9udC1mYW1pbHk6YXJpYWwiPrLiytQ8L2Rpdj48YnI+PGJyPjxzcGFuIHRpdGxlPSJuZXRlYXNlZm9vdGVyIj48c3BhbiBpZD0ibmV0ZWFzZV9tYWlsX2Zvb3RlciI+PC9zcGFuPjwvc3Bhbj4=");
