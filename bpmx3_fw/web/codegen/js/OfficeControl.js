...
*/		
	...
	this.getControlHtml=function(controlId){
			var cabPath=__ctx +"/media/office/OfficeControl.cab#version=5,0,2,7";
			var str = '';
			if (Sys.ie) {
				str = '<object  id="'+controlId+'" codeBase="'+cabPath+'" height="'+this.height+'" width="'+this.width+'" classid="clsid:A64E3073-2016-4baf-A89D-FFE1FAA10EC0" style="z-index:-1;">';
				...
				str +='clsid="{A64E3073-2016-4baf-A89D-FFE1FAA10EC0}" >';
