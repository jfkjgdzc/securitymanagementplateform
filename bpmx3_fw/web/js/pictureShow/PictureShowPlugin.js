...
PictureShowPlugin={
		...
		init:function(){
			...
			$(this.fileObjs).each(function(){
				$(this).attr("class","hidden");
				var fn=$(this).attr("name");
				var fn_=fn.replace(new RegExp(":","g"),"_");
				if($("#div_"+fn_).length){
					return;
				}
				var html='<div id="div_'+fn_+'" style="'+$(this).attr("style")+'" class="pictureShow-div">';
				html+='<div id="div_'+fn_+'_container"></div>';
				html+='<table id="pictureShow_'+fn_+'_Toolbar">';
				html+='<tbody>';
				html+='<tr>';
				html+='<td width="80">';
				html+='<a href="javascript:;" field="'+fn+'" class="link selectFile" atype="uploadPicture" onclick="{PictureShowPlugin.upLoadPictureFile(this);}">上传图片</a>';
				html+='</td>';
				html+='<td width="80">';
				html+='<a href="javascript:;" field="'+fn+'" class="link del" atype="delPicture" onclick="{PictureShowPlugin.deletePictureFile(this);}">删除图片</a>';
				html+='</td>';
				html+='</tr>';
				html+='</tbody>';
				html+='</table>';
