UE.registerUI('instqrcode', function(editor, uiName) {
	...
	var btn = new UE.ui.Button({
		...
		onclick : function() {
			...
			var div = $('<div id="qrcode" class="qrcode"><image id="tempCode" src="'+__ctx+'/styles/default/images/qrcode128.png"></image></div>');
			$(element).append(div);
			$(element).append('<script>window.onload=function(){$("#tempCode").remove();}</script>');
		}
	});
